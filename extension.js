...
function activate(context) {
    ...
    const disposable = vscode.commands.registerCommand('systeme-design-helper.createMicroservices', async function () {
    ...
    context.subscriptions.push(disposable, openDrawingBoardCommand);
}
...
function getWebviewContent() {
    ...
    <body class="light-mode">
        ...
        <script>
            ...
            // Existing drag and drop and canvas drawing logic...
        </script>
    </body>
    </html>`;
}
